                    ...
                    <div className="space-y-8 sm:space-y-0 sm:flex sm:justify-between sm:items-center xl:block xl:space-y-8">
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="space-y-1">
                                <div className="text-sm leading-5 font-medium text-gray-900">{currentUser.name}</div>
                                {/* <a href="/15" className="group flex items-center space-x-2.5">
                                    ...
                                    <div className="text-sm leading-5 text-gray-500 group-hover:text-gray-900 font-medium truncate">{currentUser.name}</div>
                                </a> */}
                            </div>
                        </div>
                        <div className="flex flex-col space-y-3 sm:space-y-0 sm:space-x-3 sm:flex-row xl:flex-col xl:space-x-0 xl:space-y-3">
                            <Link to={getRoute('projects-create').path} className="inline-flex rounded-md shadow-sm">
                                <Button bgColor="orange" bgColorIntensity="500" bgColorHoverIntensity="400" bgColorFocusIntensity="600" textColor="white" textColorIntensity="600" size="full" textSize="text-sm">
                                    New Project
                                </Button>
                            </Link>
                        </div>
