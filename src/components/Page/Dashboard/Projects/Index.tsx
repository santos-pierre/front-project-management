                ...
                <li className="relative pl-4 pr-6 py-5 hover:bg-gray-50 sm:py-6 sm:pl-6 lg:pl-8 xl:pl-6">
                    <div className="flex items-center justify-between space-x-4">
                        <div className="min-w-0 space-y-3">
                            ...
                            <a href="/5" className="relative group flex items-center space-x-2.5">
                        ...
                        <div className="hidden sm:flex flex-col flex-shrink-0 items-end space-y-3">
                            <p className="flex items-center space-x-4">
                                <a href="/5" className="relative text-sm leading-5 text-gray-500 hover:text-gray-900 font-medium">
                                    Visit site
                                </a>
