                    ...
                    <div className="space-y-8 sm:space-y-0 sm:flex sm:justify-between sm:items-center xl:block xl:space-y-8">
                        <div className="flex items-center space-x-3">
                            <div className="space-y-1 w-full">
                                ...
                                <a href={project.repository_url} target="_blanck" className="group flex items-center space-x-2.5 text-gray-500 ">
                                    <svg className="w-4 h-4 text-gray-400 group-hover:text-gray-500" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="text-sm leading-5 text-gray-500 group-hover:text-gray-900 font-medium truncate lg:w-40 w-64" title={project.repository_url}>{project.repository_url}</div>
                                </a>
                                ...
                                <span className="group flex items-center space-x-2.5 text-gray-500">
                                    ...
                                    <div className="text-sm leading-5 text-gray-500 group-hover:text-gray-900 font-medium">{project.deadline ? moment.unix(project.deadline).format("DD-MM-YYYY") : "DD-MM-YYYY"}</div>
                                </span>
                                <span className="group flex items-center space-x-2.5 text-gray-500">
                                    ...
                                    <div className="text-sm leading-5 text-gray-500 group-hover:text-gray-900 font-medium">{upperFirst(project.status).replace('_', ' ')}</div>
                                </span>
                                {project.description &&
